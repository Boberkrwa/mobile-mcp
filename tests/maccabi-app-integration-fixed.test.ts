...
describe("🧪 Maccabi App - Integration Tests", () => {
	...
	describe("🏗️ Basic Integration Tests", () => {
		...
		it("📋 Registration Flow Initialization", async function() {
			this.timeout(45000);
		...
		it("🎯 Driver Manager Integration", async function() {
			this.timeout(30000);
	...
	describe("👥 Data-Driven Registration Tests", () => {
		...
		testUsers.forEach((user, index) => {
			it(`👤 Registration Test for User ${index + 1}: ${user.id}`, async function() {
				this.timeout(120000);
	...
	describe("🔧 Configuration and Environment Tests", () => {
		...
		it("⚙️ Configuration Validation", async function() {
			this.timeout(15000);
		...
		it("📱 Platform Integration", async function() {
			this.timeout(30000);
		...
		it("🧪 Test Data Integrity", async function() {
			this.timeout(10000);
	...
	describe("⚡ Performance and Reliability Tests", () => {
		...
		it("📊 Performance Benchmarking", async function() {
			this.timeout(180000);
		...
		it("🔄 Stability Under Repeated Operations", async function() {
			this.timeout(240000);
	...
	describe("🛡️ Error Handling and Edge Cases", () => {
		...
		it("🚨 Graceful Error Handling", async function() {
			this.timeout(60000);
		...
		it("🔄 Recovery After Issues", async function() {
			this.timeout(90000);
